...
Controller::Controller(int numPlayers, int boardSize) : graphicsEnabled{false},
                                                        boardSize{boardSize},
...
void Controller::init(int argc, char *argv[])
{
    ...
    gameState = std::make_unique<GameState>(numPlayers, boardSize, loadLinkFiles(), abilities);
